...
namespace LeaderboardBackend.Migrations
{
    ...
    [Migration("20221005162709_CreateRunVariables")]
    partial class CreateRunVariables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeaderboardBackend.Models.Entities.VariableValue", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_variable_values");

                    b.ToTable("variable_values", (string)null);
                });

            modelBuilder.Entity("RunVariableValue", b =>
                {
                    b.Property<Guid>("RunsId")
                        .HasColumnType("uuid")
                        .HasColumnName("runs_id");

                    b.Property<long>("VariableValuesId")
                        .HasColumnType("bigint")
                        .HasColumnName("variable_values_id");

                    b.HasKey("RunsId", "VariableValuesId")
                        .HasName("pk_run_variable_value");

                    b.HasIndex("VariableValuesId")
                        .HasDatabaseName("ix_run_variable_value_variable_values_id");

                    b.ToTable("run_variable_value", (string)null);
                });
            ...
            modelBuilder.Entity("RunVariableValue", b =>
                {
                    b.HasOne("LeaderboardBackend.Models.Entities.Run", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_run_variable_value_runs_runs_id");

                    b.HasOne("LeaderboardBackend.Models.Entities.VariableValue", null)
                        .WithMany()
                        .HasForeignKey("VariableValuesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_run_variable_value_variable_values_variable_values_id");
                });
