...
namespace LeaderboardBackend.Migrations
{
    ...
    [Migration("20250629224333_LeaderboardsNoNumericSlugs")]
    partial class LeaderboardsNoNumericSlugs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "run_type", new[] { "score", "time" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "sort_direction", new[] { "ascending", "descending" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "user_role", new[] { "administrator", "banned", "confirmed", "registered" });
                    ...
                    b.ToTable("leaderboards", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_leaderboards_slug_RegularExpression", "slug ~ '^(?!([0-9]+)$)[a-zA-Z0-9\\-_]*$'");
                        });
                });
